                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <label className="block">
                    ...
                    <input
                      ...
                      value={form.email}
                      onChange={handleChange}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-400"
                      placeholder="Enter your email"
                      required
                    />
                  </label>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full mt-4 mb-2 py-3 text-white rounded-lg font-semibold transition bg-gradient-to-r from-[#E63946] to-[#9D2FFF] hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {loading
                      ? mode === "login"
                        ? "Logging in..."
